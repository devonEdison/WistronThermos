 ...
 */
public class SimpleDarkAdapter extends ArrayAdapter<String> {
	public SimpleDarkAdapter(Context context) {
		super(context, 0);
	}
	...
	public View getView(int position, View convertView, ViewGroup viewGroup) {
		...
		final Holder holder;
		if(v == null){
			v = LayoutInflater.from(getContext()).inflate(R.layout.simple_list_row_dark, null);
			holder = new Holder();
